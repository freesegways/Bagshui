Bagshui:LoadComponent(function()
    BsLocalization:AddLocale("enUS", {
        ...
        ["Menu_Group_Move_Category_TooltipText"] =
        "Pick up a category that is currently assigned to this group so it can be moved to another group.",
        ...
        ["Menu_Group_HideStockBadge_TooltipText"] =
        ...
        ["Menu_Item_AssignToCategory_TooltipText"] =
        "Assign this item's ID to one or more custom categories (as opposed to using rule functions).",
        ["Menu_Item_AssignToCategory_CreateNew_TooltipText"] = "Assign the item to a new custom category.",
        ["Menu_Item_AssignToCategory_Hint_CustomOnly"] =
        "Built-in Categories are read-only - see FAQ on the Bagshui Wiki for reasoning.",
        ...
        ["Menu_Item_Information_TooltipText"] =
        "View details about this item's properties and access the Item Information window.",
        ...
        ["Menu_Item_RemoveFromEquippedGear_TooltipText"] =
        "Take this item out of the list of gear you've equipped (i.e. the Equipped() rule will no longer match).",
        ...
        "One or more Bagshui rule functions, combined with and/or/not keywords, optionally grouped via parentheses. See documentation for help.",
        ["CategoryEditor_Field_list"] = "Assigned Items",
        ["CategoryEditor_Field_list_TooltipText"] =
        "List of items that are directly assigned to this category instead of using rule functions.",
        ["CategoryEditor_ID_TooltipTitle"] = "Category ID",
        ["CategoryEditor_ID_TooltipText"] =
        "Pass to the MatchCategory() rule function to check if an item matches this Category.",
        -- Button tooltips.
        ...
        ["ShareManager_ExportEncodeExplanation"] =
        "Please share the optimized (compressed/encoded) version, since it's pretty much guaranteed to survive any form of internet transmission. To review what is being shared, copy the un-optimized version into a text editor.",
        ...
        ["RuleFunction_ActiveQuest_ExampleDescription1"] =
        "Check if the item is a quest objective in the current character's quest log.",
        ...
        ["RuleFunction_BindsOnEquip_ExampleDescription1"] = string.format("Check if the item %s",
            string.lower(_G.ITEM_BIND_ON_EQUIP)),

        ["RuleFunction_CharacterLevelRange_GenericDescription"] =
        "Check if the item is usable based on the current character's level.",
        ["RuleFunction_CharacterLevelRange_Example1"] = 'CharacterLevelRange()',
        ["RuleFunction_CharacterLevelRange_ExampleDescription1"] =
        "Check if the item is usable at exactly the current character's level.",
        ["RuleFunction_CharacterLevelRange_Example2"] = 'CharacterLevelRange(levelsBelowOrAbove)',
        ["RuleFunction_CharacterLevelRange_ExampleDescription2"] =
        "Check if the item is usable at <levelsBelowOrAbove> the current character's level.",
        ["RuleFunction_CharacterLevelRange_Example3"] = 'CharacterLevelRange(levelsBelow, levelsAbove)',
        ["RuleFunction_CharacterLevelRange_ExampleDescription3"] =
        "Check if the item is usable at <below> through <above> levels around the current character's level.",
        ...
        ["RuleFunction_EquipLocation_ExampleDescriptionExtra2"] =
        "Check if the item can be equipped in any of the specified slots.",
        ...
        ["RuleFunction_ItemString_GenericDescription"] =
        ...
        ["RuleFunction_ItemString_ExampleDescription4"] =
        "Check if the item string begins with 'item:<itemId>:<enchantId>:<suffixId>:' (the item: prefix is optional).",
        ["RuleFunction_ItemString_ExampleExtra1"] = 'ItemString(param1, param2, paramN)',
        ["RuleFunction_ItemString_ExampleDescriptionExtra1"] =
        'Check if the item string matches any of the specified parameters.',

        ["RuleFunction_Location_GenericDescription"] =
        "Check if the item is stored in a specific location (Bags, Bank, etc.)",
        ...
        ["RuleFunction_Location_ExampleDescriptionExtra1"] =
        "Check if the item is stored in any of the specified locations.",
        ...
        ["RuleFunction_MatchCategory_Note"] =
        ...
        ["RuleFunction_Name_GenericDescription"] =
        "Check if the item name contains the specified string(s).!!RuleFunction_LuaStringPatternsSupported!!",
        ["RuleFunction_Name_Example1"] = 'Name("string")',
        ["RuleFunction_Name_ExampleDescription1"] =
        "Check if the item name contains the specified string.!!RuleFunction_LuaStringPatternsSupported!!",
        ["RuleFunction_Name_ExampleExtra1"] = 'Name("string1", "string2", "stringN")',
        ["RuleFunction_Name_ExampleDescriptionExtra1"] =
        "Check if the item name contains any of the specified strings.!!RuleFunction_LuaStringPatternsSupported!!",
        ...
        ["RuleFunction_NameExact_ExampleDescriptionExtra1"] =
        "Check if the item name exactly matches any of the specified strings.",
        ...
        ["RuleFunction_Outfit_ExampleDescriptionExtra1"] =
        "Check if the item is part of any of the specified outfits in %s.",

        ["RuleFunction_PeriodicTable_GenericDescription"] =
        "Check if the item belongs to a PeriodicTable set.!!RuleFunction_PT_CaseSensitiveParameters!!",
        ["RuleFunction_PeriodicTable_ExampleDescription"] =
        "Check if the item belongs to the '%s' PeriodicTable set.!!RuleFunction_PT_CaseSensitiveParameters!!",
        ["RuleFunction_PeriodicTable_ExampleExtra1"] = 'PeriodicTable("set1", "set2", "setN")',
        ["RuleFunction_PeriodicTable_ExampleDescriptionExtra1"] =
        "Check if the item belongs to any of the specified PeriodicTable sets.!!RuleFunction_PT_CaseSensitiveParameters!!",
        ...
        "Check if the item is crafted by the current character's professions (learned recipes only).",
        ["RuleFunction_ProfessionCraft_Example1"] = 'ProfessionCraft()',
        ["RuleFunction_ProfessionCraft_ExampleDescription1"] =
        "Check if the item is crafted by any of the current character's professions (learned recipes only).",
        ["RuleFunction_ProfessionCraft_Example2"] = 'ProfessionCraft("Profession Name")',
        ["RuleFunction_ProfessionCraft_ExampleDescription2"] =
        "Check if the item is crafted by the current character's specified profession (learned recipes only).",
        ["RuleFunction_ProfessionCraft_ExampleExtra1"] = 'ProfessionCraft("Profession1", "Profession2", "ProfessionN")',
        ["RuleFunction_ProfessionCraft_ExampleDescriptionExtra1"] =
        "Check if the item is crafted by any of the current character's specified professions (learned recipes only).",

        ["RuleFunction_ProfessionReagent_GenericDescription"] =
        "Check if the item is a reagent for the current character's profession crafts (learned recipes only).",
        ["RuleFunction_ProfessionReagent_Example1"] = 'ProfessionReagent()',
        ["RuleFunction_ProfessionReagent_ExampleDescription1"] =
        "Check if the item is a reagent for any of the current character's profession crafts (learned recipes only).",
        ["RuleFunction_ProfessionReagent_Example2"] = 'ProfessionReagent("Profession Name")',
        ["RuleFunction_ProfessionReagent_ExampleDescription2"] =
        "Check if the item is a reagent for the current character's specified profession (learned recipes only).",
        ["RuleFunction_ProfessionReagent_ExampleExtra1"] =
        'ProfessionReagent("Profession1", "Profession2", "ProfessionN")',
        ["RuleFunction_ProfessionReagent_ExampleDescriptionExtra1"] =
        "Check if the item is a reagent for any of the current character's specified professions (learned recipes only).",
        ...
        ["RuleFunction_RecentlyChanged_ExampleDescription5"] =
        'Check if the item is new or stock has increased, but ignore stock decreases.',
        ...
        ["RuleFunction_RequiresClass_ExampleDescriptionExtra1"] =
        "Check if the item is usable by the any of the specified classes.",
        ...
        ["RuleFunction_Tooltip_GenericDescription"] =
        "Check if the tooltip contains the specified string(s).!!RuleFunction_LuaStringPatternsSupported!!",
        ["RuleFunction_Tooltip_Example1"] = 'Tooltip("string")',
        ["RuleFunction_Tooltip_ExampleDescription1"] =
        "Check if the item tooltip contains the specified string.!!RuleFunction_LuaStringPatternsSupported!!",
        ["RuleFunction_Tooltip_ExampleExtra1"] = 'Tooltip("string1", "string2", "stringN")',
        ["RuleFunction_Tooltip_ExampleDescriptionExtra1"] =
        "Check if the tooltip contains any of the specified strings.!!RuleFunction_LuaStringPatternsSupported!!",

        ["RuleFunction_Transmog_GenericDescription"] =
        "Check if the item is in your transmog collection or is eligible to be transmogged.",
        ...
        ["RuleFunction_Transmog_ExampleDescription3"] =
        'Check if the item is transmoggable but has not yet been added to your collection.',
        ...
        ["RuleFunction_Usable_ExampleDescription1"] =
        "Check if the item is usable by the current character based on level, skills, and professions.",
        ...
        ["Error"] = "Error",
        ["Error_AddonDependency_Generic"] =
        "An additional addon is required to enable this rule function (refer to the Rules page on the Bagshui wiki).",
        ["Error_AddonDependency_Generic_FunctionName"] =
        "An additional addon is required to enable the use of %s (refer to the Rules page on the Bagshui wiki).",
        ...
        ["Warning_BuiltinRuleFunctionCollision"] =
        "3rd party rule function/alias %s() was not loaded because it is the name/alias of a built-in Bagshui rule function",
        ...
        ["Compat_pfUIBagsInfo"] =
        "If you change your mind, the pfUI Bags module can be managed in pfUI Config > Components > Modules.",
        ...
        ["Compat_tDFAllInOneBags"] =
        "Disabling the tDF All-In-One-Bag module is recommended if you want to use Bagshui as your default bags.",
        ["Compat_tDFAllInOneBagsInfo"] =
        "If you change your mind, the tDF All-In-One-Bag module can be managed in tDF Options.",

        -- Rule function errors.
        ["Error_RuleFunctionInvalid"] =
        '«%s» is not a valid rule function -- if intended as a parameter, be sure to quote it like Function("parameter")',
        ...
        ["Error_RuleTooManyArguments"] =
        "Rule functions are limited to 50 parameters. To use more parameters, add a second call to %s separated by 'or', like this: or %s(param1, param2, etc)",

        ["Error_Rule_ItemLevelStat"] = "Vanilla WoW doesn't have item levels (ilvl) so ItemLevelStat() is not available.",
        ["Error_Rule_ItemStat"] =
        "ItemStat() and ItemStatActive() are not currently supported. Try using Tooltip() to check for stats instead.",

        ["Error_Rule_MatchCategory_Loop"] = "MatchCategory() loop detected:",
        ["Error_Rule_MatchCategory_DownstreamError"] =
        "MatchCategory() unable to proceed due to error in referenced category %s.",
        ...
        ["Setting_BagUsageDisplay_Smart_TooltipText"] =
        "Show utilization summary when empty slot stacking is off (or hovering over bag slots).",
        ["Setting_BagUsageDisplay_Never"] = "Never",
        ["Setting_BagUsageDisplay_Never_TooltipTitle"] = "Summary Never Visible",
        ["Setting_BagUsageDisplay_Never_TooltipText"] =
        "Utilization summary will never be displayed (except when hovering over bag slots).",
        ...
        ["bagUsageAlwaysShow_TooltipText"] =
        "Always display utilization over each bag (only applies if bag slots are visible).",
        ...
        ["defaultSortOrder_TooltipText"] =
        "How groups will be sorted when they don't have a specific sort order assigned.",
        ...
        ["globalInfoTooltips_TooltipText"] =
        "Show the Bagshui Info Tooltip when Alt is held while any item tooltip is displayed (i.e. Character window, chat links, etc.).",
        ...
        ["hideGroupLabelsOverride_TooltipText"] =
        "Suppress the display of group labels, even if the Design Group Labels setting is enabled.",
        ...
        ["itemStockChangeClearOnInteract_TooltipText"] =
        "Immediately reset the item stock change state (new/increased/decreased) upon interaction.",

        ["itemStockChangeExpiration"] = "Expiration",
        ["itemStockChangeExpiration_TooltipTitle"] = "Item Stock Badge Change Expiration",
        ["itemStockChangeExpiration_TooltipText"] =
        "After this time has elapsed, an item will no longer be considered changed (new/increased/decreased).",

        ["itemStockBadgeFadeDuration"] = "Fade",
        ["itemStockBadgeFadeDuration_TooltipTitle"] = "Item Stock Badge Fade Duration",
        ["itemStockBadgeFadeDuration_TooltipText"] =
        "Stock change badges (new/increased/decreased) will begin fading this amount of time prior to the Expiration setting.",
        ...
        "Always display the Bagshui Info Tooltip (hold Shift to hide it temporarily).",
